...
.genome_descriptions <- function() {
  rbind(
    ...
    .sm_col("genome_effect_members", "id_genome_effect",
            "Term identifier; FK to genome_effects.id_genome_effect; part of the primary key"),
    ...
    .sm_col("genome_effect_member_origins", "id_genome_effect",
            "Term identifier; part of the primary key and of the FK to genome_effect_members"),
    .sm_col("genome_effect_member_origins", "member_slot",
            "Member this scope applies to; part of the primary key and of the FK to genome_effect_members"),
